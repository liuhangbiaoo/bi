...
//图例一
var tag = ["男", "女"];
var data = [{ name: "男", value: 72 }, { name: "女", value: 27 }];
libpies("c1", "客户性别分布", tag, data, '65%');

//图例二
var tag1 = ["幼儿", "12~16","17~25","26-39","40以上"];
var data1 = [{ name: "幼儿", value: 72 }, { name: "12~16", value: 27 }, { name: "17~25", value: 24 }, { name: "26-39", value: 34 }, { name: "40以上", value: 27 }];
libpies("c2", "客户年龄分布", tag1, data1, ['50%', '70%']);

// 图例三
var tag2 = ["大专", "本科", "考研"];
var data2 = [{ name: "大专", value: 72 }, { name: "本科", value: 27 }, { name: "考研", value: 37 }];
libpies("c3", "客户学历分布", tag2, data2, ['20%', '70%'], function(option) {
    option.series[0].roseType = "radius"
});

// 图例四
libpies("c4", "客户年龄分布", " ", " ", [0, '30%'], function(option) {
    option.series[0] = {
        name: '访问来源',
        type: 'pie',
        selectedMode: 'single',
...
// 图例五
libpies("c5", "图例五", " ", " ", [0, '30%'], function(option) {
...
// 图例六
libpies("c6", "图例六", " ", " ", [0, '30%'], function(option) {
    option.series[0] = {
        name: 'pie',
        type: 'pie',
        selectedMode: 'single',
...
// 图例七
var tag3 = ["百度", "天涯", "新浪", "网易"];
var data3 = [21, 72, 54, 28];
xybar("c7", "图例七", tag3, data3)

// 图例八
var data31 = [21, 12, 32, 13, 54],
    data32 = [24, 43, 24, 23, 64],
    cat8=['巴西','印尼','美国','印度','中国','世界人口(万)'];
xybar("c8", "图例八", cat8, " ", "x", function(option) {
    option.legend = {
        data: ['网站', '博客']
    };
    option.series = [{ name: "网站", type: 'bar', data: data31 }, { name: "博客", type: 'bar', data: data32 }];

});

// 图例九
var tag5 = ["百度", "天涯", "新浪", "网易"];
var data5 = [21, 72, 54, 28];
xybar("c9", "图例九", tag5, data5, "y")

// 图例十
var data10 = [21, 12, 32, 13, 54],
    data101 = [24, 43, 24, 23, 64],
    cat8=['巴西','印尼','美国','印度','中国','世界人口(万)'];
xybar("c10", "图例十", cat8, " ", "y", function(option) {
    option.legend = {
        data: ['网站', '博客']
    };
    option.series = [{ name: "网站", type: 'bar', data: data10 }, { name: "博客", type: 'bar', data: data101 }];
...
for (var i = 0; i < 100; i++) {
    xAxisData.push('类目' + i);
    data111.push((Math.sin(i / 5) * (i / 5 -10) + i / 6) * 5);
    data121.push((Math.cos(i / 5) * (i / 5 -10) + i / 6) * 5);
}

xybar("c11", "图例十一", "-", " "," ", function(option) {
        option.legend={
            data: ['bar', 'bar2'],
            align: 'left'
        }
...
//图例十二
var tag12=["邮件营销"];
var cat12=["周一","周二","周三","周四","周五","周六","周日"];
var data12=[12,32,45,23,13,53,24];
libline("c12","邮件营销",tag12,cat12,data12)
//图例十三
var tag13=['邮件营销','联盟广告','视频广告','直接访问','搜索引擎'];
var cat13=["周一","周二","周三","周四","周五","周六","周日"];
var data13=[13,32,45,23,13,53,24];
libline("c13","邮件营销",tag13,cat13," ",function(option){
    option.series=[
        {
            name:'搜索引擎',
            type:'line',
...
//图例十四
var tag14=['最高气温','最低气温'];
var cat14=["周一","周二","周三","周四","周五","周六","周日"];
var data14=[14,32,45,23,14,53,24];
libline("c14","邮件营销",tag14,cat14," ",function(option){
    option.series=[
       {
            name:'最高气温',
            type:'line',
...
libline("c15","邮件营销",tag15," "," ",function(option){
    option.series=[
        {
...
//图例十六
var tag16=['line'];
var cat16=['00:00', '01:15', '02:30', '03:45', '05:00', '06:15', '07:30', '08:45', '10:00', '11:15', '12:30', '13:45', '15:00', '16:15', '17:30', '18:45', '20:00', '21:15', '22:30', '23:45'];
libline("c16","邮件营销",tag16,cat16," ",function(option){
    option.series=[
        {
            name:'用电量',
            type:'line',
...
//图例十七
var tag17=['高度(km)与气温(°C)变化关系'];
var cat17= ['0', '10', '20', '30', '40', '50', '60', '70', '80'];
libline("c17","邮件营销",tag17,cat17," ",function(option){
    option.series=[
         {
...
//图例十八
var cat18= ['周一','周二','周三','周四','周五','周六','周日'];
xybar("c18", "图例十", cat18, " ", "y", function(option) {
    option.legend={
            data:['利润', '支出', '收入']
    };
    option.series = [
...
//图例十九
var cat19= ['周一','周二','周三','周四','周五','周六','周日'];
xybar("c19", "图例十", cat19, " ", "x", function(option) {
    option.legend={
...
//图例二十
var cat20= ['周一','周二','周三','周四','周五','周六','周日'];
xybar("c20", "图例十", cat20, " ", "y", function(option) {
    option.legend={
            data:['直接访问','邮件营销','联盟广告','视频广告','搜索引擎','百度','谷歌','必应','其他']
    };
    option.series = [
...
xybar("c21", "二十一", cat21, " ", "x", function(option) {
   option.legend={
        data:['蒸发量','降水量']
    }
    option.series = [
...
//图例二十二
xybar("c22", "图例二十二", " ", " ", "x", function(option) {
   option.legend={
        data:['最新成交价', '预购队列']
    }
    option.series = [
    ...
    var count=11;
    clearInterval(setInterval(function (option){
...
//图例二十三
xybar("c23", "图例二十三", " ", " ", "x", function(option) {
   option.legend={
        data:['蒸发量','降水量','平均温度']
    }
    option.series = [
...
c24();
function c24(){
     var myChart = echarts.init(document.getElementById("c24"));
...
option = {
    color:['#7996d2', '#f8e594', '#f78db3', '#a498b9', '#ffabac', '#a0dca0', '#90d4e7', '#87b1e6', '#6fcdb2', '#e5b4b2'],
    baseOption: {
        timeline: {
            // y: 0,
            axisType: 'category',
    ...
    option.color=['#7996d2', '#f8e594', '#f78db3', '#a498b9', '#ffabac', '#a0dca0', '#90d4e7', '#87b1e6', '#6fcdb2', '#e5b4b2'];
    myChart.setOption(option);
}
...
var tharr=["商品名称","销量","周转天数","周转次数"];
var trarr=[["红富士苹果1","98%","1243","23"],["红富士苹果2","98%","1243","23"],["红富士苹果3","98%","1243","23"],["红富士苹果4","98%","1243","23"],["红富士苹果5","98%","1243","23"],["红富士苹果","98%","1243","23"],["红富士苹果","98%","1243","23"],["红富士苹果","98%","1243","23"],["红富士苹果","98%","1243","23"],["红富士苹果","98%","1243","23"],["红富士苹果","98%","1243","23"],["红富士苹果","98%","1243","23"],["红富士苹果","98%","1243","23"],["红富士苹果","98%","1243","23"],["红富士苹果","98%","1243","23"],["红富士苹果","98%","1243","23"],["红富士苹果","98%","1243","23"],["红富士苹果","98%","1243","23"]];
biTable("#c25",tharr,trarr);
